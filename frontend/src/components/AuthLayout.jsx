                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '2rem', marginBottom: '3rem', fontSize: '0.875rem', fontWeight: '500' }}>
                    ...
                    {typeof onTabChange === 'function' ? (
                        <div style={{ display: 'flex', gap: '1.5rem' }}>
                            ...
                            <button
                                onClick={() => onTabChange('signup-msme')}
                                style={{
                                    background: 'none', border: 'none', cursor: 'pointer',
                                    color: activeTab === 'signup-msme' ? 'var(--primary)' : 'var(--text-muted)',
                                    borderBottom: activeTab === 'signup-msme' ? '2px solid var(--primary)' : '2px solid transparent',
                                    paddingBottom: '0.25rem',
                                    fontFamily: 'inherit', fontSize: 'inherit', fontWeight: 'inherit'
                                }}
                            >
                            ...
                            <button
                                onClick={() => onTabChange('signup-driver')}
                                style={{
                                    background: 'none', border: 'none', cursor: 'pointer',
                                    color: activeTab === 'signup-driver' ? 'var(--primary)' : 'var(--text-muted)',
                                    borderBottom: activeTab === 'signup-driver' ? '2px solid var(--primary)' : '2px solid transparent',
                                    paddingBottom: '0.25rem',
                                    fontFamily: 'inherit', fontSize: 'inherit', fontWeight: 'inherit'
                                }}
                            >
